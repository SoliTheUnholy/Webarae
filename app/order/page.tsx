            ...
            {step < pages.length ? (
              <>
                ...
                <CardContent className="grid gap-2">
                  {pages[step].options.map((item, index) => {
                    if (index + 1 == pages[step].options.length) {
                      return (
                        <AnimatedContent
                          visible={animate}
              ...
              <>
                ...
                <CardHeader className="gap-0">
                  <AnimatedContent animateOpacity visible={animate}>
                    <CardTitle>
                      <SplitText splitType="words" tag="h3" text="جمع بندی" />
                    </CardTitle>
                    <CardDescription>
                      <SplitText
                        splitType="words"
                ...
                <CardFooter className="grid gap-2 text-center">
                  ...
                  <Button className="w-full rounded-xl">تکمیل سفارش</Button>
                </CardFooter>
              </>
            )}
          </Card>
