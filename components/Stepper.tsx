                    ...
                    <div className={`px-8 pb-8 ${footerClassName}`}>
                        ...
                        >
                            ...
                            <Button
                                ...
                                className="flex items-center justify-center rounded-xl px-3.5 py-1.5 font-medium tracking-tight transition duration-350 hover:cursor-pointer"
                                {...nextButtonProps}
                            >
        ...
        >
            ...
            >
                {status === "complete" ? (
                    ...
                    <div className="bg-background h-3 w-3 rounded-xl" />
                ) : (
...
function StepConnector({ isComplete }: StepConnectorProps) {
    ...
    return (
        <div className="bg-background relative mx-2 h-0.5 flex-1 overflow-hidden rounded">
            <motion.div
                className="right-0-0 absolute top-0 h-full"
