        ...
        >
            <div
                ...
                style={
                    accentColor
                        ? ({
                              ["--sidebar-ring" as any]: accentColor,
            ...
            >
                <div
                    ref={preLayersRef}
                    className="sm-prelayers pointer-events-none fixed top-0 right-0 bottom-0 z-[5]"
                    aria-hidden="true"
                >
                    {(() => {
                        const raw =
                ...
                <aside
                    ...
                    ref={panelRef}
                    className="staggered-menu-panel bg-sidebar fixed top-0 right-0 z-10 flex h-full flex-col overflow-y-auto p-[6em_2em_2em_2em] backdrop-blur-[12px]"
                    ...
                    <div className="sm-panel-inner flex flex-1 flex-col gap-5">
                        ...
                        >
                            {items && items.length ? (
                                ...
                                <li
                                    ...
                                    aria-hidden="true"
                                >
                                    <span className="sm-panel-item text-foreground relative inline-block cursor-pointer pr-[1em] text-[3rem] leading-none font-semibold tracking-[-2px] uppercase no-underline transition-[background,color] duration-150 ease-linear">
                        ...
                        {displaySocials &&
                            ...
                            socialItems.length > 0 && (
                                ...
                                >
                                    <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sidebar-ring,#ff0000)]">
                                        شبکه های اجتماعی
                                    </h3>
                                    <ul
                                        ...
                                        {socialItems.map((s, i) => (
                                            ...
                                            >
                                                <Link
                                                    ...
                                                    className="sm-socials-link text-foreground relative inline-block py-[2px] text-[1.2rem] font-medium no-underline transition-[color,opacity] duration-300 ease-linear"
                                                >
                                                    {s.label}
                                                </Link>
                                            </li>
...
.sm-scope .staggered-menu-header { position: fixed; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between;  pointer-events: none; z-index: 20; }
...
.sm-scope .staggered-menu-panel { position: fixed; top: 0; right: 0; width: clamp(320px, 25vw, 440px); height: 100%; background: var(--sidebar); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: fixed; top: 0; right: 0; bottom: 0; width: clamp(320px, 25vw, 440px); pointer-events: none; z-index: 5; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sidebar-ring, #ff0000); outline-offset: 3px; }
