		...
		<div
			...
			<div
				...
				<aside
					...
					ref={panelRef}
					className="staggered-menu-panel absolute shadow-2xl top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
